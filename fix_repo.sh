# Remove the stuff after the closing brace
sed -i '/^\/\/ Will overwrite using sed instead/,$d' app/src/main/java/com/example/financetracker/repository/FinanceRepository.kt
# Remove the closing brace
sed -i '$d' app/src/main/java/com/example/financetracker/repository/FinanceRepository.kt

# Append the methods and the closing brace
